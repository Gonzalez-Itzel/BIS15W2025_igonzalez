...
**The Woodland habitat has the greatest species diversity**
```{r}
...
**The minimum is 193, the maximum is 26419123, and the mean is 5969323 for the range area**
```{r}
ecosphere %>% 
...
**Moderate migratory stragety has the highest average mass**
```{r}
ecosphere %>% 
...
**Wetland and Ocean have no population size**
```{r}
...
**What is the average mass for each life expecatancy within each order?**
```{r}
ecosphere %>% 
